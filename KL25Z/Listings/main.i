...
int main(void) {
    ...
    uint8_t c;
		...
		static uint8_t endpoint_1_rx_buf0[64];
		static uint8_t endpoint_1_rx_buf1[64];
		static uint8_t endpoint_1_tx_buf0[64];
		static uint8_t endpoint_1_tx_buf1[64];
	  ...
	  if(SystemCoreClock == 48000000){
		...
		((FGPIO_Type *)(0xF80FF040u))->PDDR |= (1UL << 19);
			...
			case 0x1:
					...
					if (size == 64) {
							if(((uint8_t*)buf_desc->BufferAddress)[0] == 0x00)
							{
									...
									{
										((FGPIO_Type *)(0xF80FF040u))->PCOR = (1UL << 19);
									}
									else
									{
										((FGPIO_Type *)(0xF80FF040u))->PSOR = (1UL << 19);
									}
							}
					}
			break;
